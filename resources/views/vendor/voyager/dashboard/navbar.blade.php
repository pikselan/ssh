    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <ol class="breadcrumb hidden-xs">
                ...
                @endphp
                @if(count($segments) == 0)
                    <li class="active"><i class="voyager-laptop"></i> {{ __('voyager::generic.dashboard') }}</li>
                @else
                    <li class="active">
                        <a href="{{ route('voyager.dashboard')}}"><i class="voyager-laptop"></i> {{ __('voyager::generic.dashboard') }}</a>
                    </li>
